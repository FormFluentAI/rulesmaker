...
**Rules Count:** 7
**Keywords:** class, async, error, test, function

---

You are an expert in Python and api, database development.
...
- Follow these documented patterns: function definitions, async operations, class definitions
...
- Key concepts covered: Geographic, Other, Help, Links, Security, You, Common, Performance, Get, Follow
...
<!-- Generated from: Pytest, FastAPI, Pydantic, Django, Flask, Requests, Click -->
